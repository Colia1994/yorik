package com.colia.yorik.yorikapplication.application.order.valueObject;
 ...
 */
@Data
public class PddOrderVO implements ValueObject<PddOrderVO> {
    ...
    @Override
    public boolean sameValueAs(PddOrderVO other) {
        return false;
    }
}
