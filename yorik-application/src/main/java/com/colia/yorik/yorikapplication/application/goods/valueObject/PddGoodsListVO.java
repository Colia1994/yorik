...
@Data
public class PddGoodsListVO implements ValueObject<PddGoodsListVO> {

    /**
     * 列表
     */
    private List<PddGoodsListItemVO> list;
    ...
    @Override
    public boolean sameValueAs(PddGoodsListVO other) {
        return false;
    }

    @Data
    public static class PddGoodsListItemVO implements ValueObject<PddGoodsListItemVO> {
        ...
        @Override
        public boolean sameValueAs(PddGoodsListItemVO other) {
            return false;
        }
    }
}
